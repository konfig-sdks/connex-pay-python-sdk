...
from connex_pay_python_sdk.pydantic.return_search_sale_returns_response_search_result_dto import ReturnSearchSaleReturnsResponseSearchResultDto

class ReturnSearchSaleReturnsResponse(BaseModel):
    ...
    search_result_d_t_o: typing.Optional[ReturnSearchSaleReturnsResponseSearchResultDto] = Field(None, alias='searchResultDTO')
