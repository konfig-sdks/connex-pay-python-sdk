...
from connex_pay_python_sdk.pydantic.transaction_capture_authorization_response_sale_card_customer import TransactionCaptureAuthorizationResponseSaleCardCustomer

class TransactionCaptureAuthorizationResponseSaleCard(BaseModel):
    ...
    customer: typing.Optional[TransactionCaptureAuthorizationResponseSaleCardCustomer] = Field(None, alias='customer')
