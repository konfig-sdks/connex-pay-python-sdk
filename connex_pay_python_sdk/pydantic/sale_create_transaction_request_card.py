...
from connex_pay_python_sdk.pydantic.sale_create_transaction_request_card_customer import SaleCreateTransactionRequestCardCustomer
from connex_pay_python_sdk.pydantic.sale_create_transaction_request_card_three_ds import SaleCreateTransactionRequestCardThreeDs

class SaleCreateTransactionRequestCard(BaseModel):
    ...
    customer: typing.Optional[SaleCreateTransactionRequestCardCustomer] = Field(None, alias='Customer')

    three_d_s: typing.Optional[SaleCreateTransactionRequestCardThreeDs] = Field(None, alias='ThreeDS')
