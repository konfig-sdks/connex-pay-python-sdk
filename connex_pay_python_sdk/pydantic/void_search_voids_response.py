...
from connex_pay_python_sdk.pydantic.void_search_voids_response_search_result_dto import VoidSearchVoidsResponseSearchResultDto

class VoidSearchVoidsResponse(BaseModel):
    ...
    search_result_d_t_o: typing.Optional[VoidSearchVoidsResponseSearchResultDto] = Field(None, alias='searchResultDTO')
