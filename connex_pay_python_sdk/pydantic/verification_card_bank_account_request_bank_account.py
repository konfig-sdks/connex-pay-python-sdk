...
from connex_pay_python_sdk.pydantic.verification_card_bank_account_request_bank_account_customer import VerificationCardBankAccountRequestBankAccountCustomer

class VerificationCardBankAccountRequestBankAccount(BaseModel):
    ...
    customer: typing.Optional[VerificationCardBankAccountRequestBankAccountCustomer] = Field(None, alias='Customer')
