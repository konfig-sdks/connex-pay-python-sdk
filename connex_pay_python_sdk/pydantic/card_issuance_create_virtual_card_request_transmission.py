...
from connex_pay_python_sdk.pydantic.card_issuance_create_virtual_card_request_transmission_transmission_methods import CardIssuanceCreateVirtualCardRequestTransmissionTransmissionMethods

class CardIssuanceCreateVirtualCardRequestTransmission(BaseModel):
    transmission_methods: typing.Optional[CardIssuanceCreateVirtualCardRequestTransmissionTransmissionMethods] = Field(None, alias='TransmissionMethods')
