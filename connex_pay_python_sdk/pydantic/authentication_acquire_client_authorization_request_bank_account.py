...
from connex_pay_python_sdk.pydantic.authentication_acquire_client_authorization_request_bank_account_customer import AuthenticationAcquireClientAuthorizationRequestBankAccountCustomer

class AuthenticationAcquireClientAuthorizationRequestBankAccount(BaseModel):
    ...
    customer: typing.Optional[AuthenticationAcquireClientAuthorizationRequestBankAccountCustomer] = Field(None, alias='Customer')
