...
from connex_pay_python_sdk.pydantic.card_update_card_details_response_card_mid_blacklist import CardUpdateCardDetailsResponseCardMidBlacklist
from connex_pay_python_sdk.pydantic.card_update_card_details_response_card_mid_whitelist import CardUpdateCardDetailsResponseCardMidWhitelist

class CardUpdateCardDetailsResponseCard(BaseModel):
    ...
    mid_whitelist: typing.Optional[CardUpdateCardDetailsResponseCardMidWhitelist] = Field(None, alias='midWhitelist')

    mid_blacklist: typing.Optional[CardUpdateCardDetailsResponseCardMidBlacklist] = Field(None, alias='midBlacklist')

    association_id: typing.Optional[str] = Field(None, alias='associationId')

    client_program: typing.Optional[str] = Field(None, alias='clientProgram')
