...
from connex_pay_python_sdk.pydantic.ach_create_credit_payment_request_account_holder_address import AchCreateCreditPaymentRequestAccountHolderAddress
from connex_pay_python_sdk.pydantic.ach_create_credit_payment_request_account_holder_bank_account import AchCreateCreditPaymentRequestAccountHolderBankAccount

class AchCreateCreditPaymentRequestAccountHolder(BaseModel):
    ...
    address: typing.Optional[AchCreateCreditPaymentRequestAccountHolderAddress] = Field(None, alias='Address')

    bank_account: typing.Optional[AchCreateCreditPaymentRequestAccountHolderBankAccount] = Field(None, alias='BankAccount')
