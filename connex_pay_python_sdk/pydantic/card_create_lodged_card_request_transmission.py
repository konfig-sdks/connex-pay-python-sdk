...
from connex_pay_python_sdk.pydantic.card_create_lodged_card_request_transmission_transmission_methods import CardCreateLodgedCardRequestTransmissionTransmissionMethods

class CardCreateLodgedCardRequestTransmission(BaseModel):
    transmission_methods: typing.Optional[CardCreateLodgedCardRequestTransmissionTransmissionMethods] = Field(None, alias='TransmissionMethods')
