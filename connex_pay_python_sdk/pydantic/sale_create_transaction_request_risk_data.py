...
from connex_pay_python_sdk.pydantic.sale_create_transaction_request_risk_data_flight_data import SaleCreateTransactionRequestRiskDataFlightData
from connex_pay_python_sdk.pydantic.sale_create_transaction_request_risk_data_flight_passengers import SaleCreateTransactionRequestRiskDataFlightPassengers

class SaleCreateTransactionRequestRiskData(BaseModel):
    ...
    flight_data: typing.Optional[SaleCreateTransactionRequestRiskDataFlightData] = Field(None, alias='FlightData')

    flight_passengers: typing.Optional[SaleCreateTransactionRequestRiskDataFlightPassengers] = Field(None, alias='FlightPassengers')
