...
from connex_pay_python_sdk.pydantic.verification_card_bank_account_request_card_customer import VerificationCardBankAccountRequestCardCustomer
from connex_pay_python_sdk.pydantic.verification_card_bank_account_request_card_three_ds import VerificationCardBankAccountRequestCardThreeDs

class VerificationCardBankAccountRequestCard(BaseModel):
    ...
    customer: typing.Optional[VerificationCardBankAccountRequestCardCustomer] = Field(None, alias='Customer')

    three_d_s: typing.Optional[VerificationCardBankAccountRequestCardThreeDs] = Field(None, alias='ThreeDS')
