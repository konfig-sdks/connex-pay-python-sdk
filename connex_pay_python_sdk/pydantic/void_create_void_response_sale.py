...
from connex_pay_python_sdk.pydantic.void_create_void_response_sale_card import VoidCreateVoidResponseSaleCard

class VoidCreateVoidResponseSale(BaseModel):
    ...
    card: typing.Optional[VoidCreateVoidResponseSaleCard] = Field(None, alias='card')
