...
from connex_pay_python_sdk.pydantic.authentication_acquire_client_authorization_request_card_customer import AuthenticationAcquireClientAuthorizationRequestCardCustomer
from connex_pay_python_sdk.pydantic.authentication_acquire_client_authorization_request_card_three_ds import AuthenticationAcquireClientAuthorizationRequestCardThreeDs

class AuthenticationAcquireClientAuthorizationRequestCard(BaseModel):
    ...
    customer: typing.Optional[AuthenticationAcquireClientAuthorizationRequestCardCustomer] = Field(None, alias='Customer')

    three_d_s: typing.Optional[AuthenticationAcquireClientAuthorizationRequestCardThreeDs] = Field(None, alias='ThreeDS')
