...
from connex_pay_python_sdk.pydantic.void_create_void_response_sale_card_customer import VoidCreateVoidResponseSaleCardCustomer

class VoidCreateVoidResponseSaleCard(BaseModel):
    ...
    customer: typing.Optional[VoidCreateVoidResponseSaleCardCustomer] = Field(None, alias='customer')
