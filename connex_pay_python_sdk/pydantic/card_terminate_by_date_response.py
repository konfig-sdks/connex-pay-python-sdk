...
class CardTerminateByDateResponse(BaseModel):
    ...
    customer_service_phone_number: typing.Optional[str] = Field(None, alias='customerServicePhoneNumber')
    ...
    gateway_merchant_guid: typing.Optional[str] = Field(None, alias='gatewayMerchantGuid')

    available_balance: typing.Optional[int] = Field(None, alias='availableBalance')

    is_physical: typing.Optional[bool] = Field(None, alias='isPhysical')

    is_lodged: typing.Optional[bool] = Field(None, alias='isLodged')
