...
class RequiredCardIssuanceCreateVirtualCardRequestCustomParametersItem(TypedDict):
    pass

class OptionalCardIssuanceCreateVirtualCardRequestCustomParametersItem(TypedDict, total=False):
...
class CardIssuanceCreateVirtualCardRequestCustomParametersItem(RequiredCardIssuanceCreateVirtualCardRequestCustomParametersItem, OptionalCardIssuanceCreateVirtualCardRequestCustomParametersItem):
    pass
