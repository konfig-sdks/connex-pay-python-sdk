...
class RequiredSaleCreateTransactionRequestBankAccountCustomer(TypedDict):
    pass

class OptionalSaleCreateTransactionRequestBankAccountCustomer(TypedDict, total=False):
...
class SaleCreateTransactionRequestBankAccountCustomer(RequiredSaleCreateTransactionRequestBankAccountCustomer, OptionalSaleCreateTransactionRequestBankAccountCustomer):
    pass
