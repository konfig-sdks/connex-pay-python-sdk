...
class RequiredVerificationCardBankAccountRequestCardCustomer(TypedDict):
    pass

class OptionalVerificationCardBankAccountRequestCardCustomer(TypedDict, total=False):
...
class VerificationCardBankAccountRequestCardCustomer(RequiredVerificationCardBankAccountRequestCardCustomer, OptionalVerificationCardBankAccountRequestCardCustomer):
    pass
