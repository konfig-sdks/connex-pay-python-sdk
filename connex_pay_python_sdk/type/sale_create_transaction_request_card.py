...
from connex_pay_python_sdk.type.sale_create_transaction_request_card_customer import SaleCreateTransactionRequestCardCustomer
from connex_pay_python_sdk.type.sale_create_transaction_request_card_three_ds import SaleCreateTransactionRequestCardThreeDs

class RequiredSaleCreateTransactionRequestCard(TypedDict):
    pass

class OptionalSaleCreateTransactionRequestCard(TypedDict, total=False):
...
class SaleCreateTransactionRequestCard(RequiredSaleCreateTransactionRequestCard, OptionalSaleCreateTransactionRequestCard):
    pass
