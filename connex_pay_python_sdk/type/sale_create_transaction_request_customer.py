...
class RequiredSaleCreateTransactionRequestCustomer(TypedDict):
    pass

class OptionalSaleCreateTransactionRequestCustomer(TypedDict, total=False):
...
class SaleCreateTransactionRequestCustomer(RequiredSaleCreateTransactionRequestCustomer, OptionalSaleCreateTransactionRequestCustomer):
    pass
