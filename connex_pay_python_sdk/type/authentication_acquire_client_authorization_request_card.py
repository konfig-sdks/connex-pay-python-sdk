...
from connex_pay_python_sdk.type.authentication_acquire_client_authorization_request_card_customer import AuthenticationAcquireClientAuthorizationRequestCardCustomer
from connex_pay_python_sdk.type.authentication_acquire_client_authorization_request_card_three_ds import AuthenticationAcquireClientAuthorizationRequestCardThreeDs

class RequiredAuthenticationAcquireClientAuthorizationRequestCard(TypedDict):
    pass

class OptionalAuthenticationAcquireClientAuthorizationRequestCard(TypedDict, total=False):
    ...
    Customer: AuthenticationAcquireClientAuthorizationRequestCardCustomer

    ThreeDS: AuthenticationAcquireClientAuthorizationRequestCardThreeDs

class AuthenticationAcquireClientAuthorizationRequestCard(RequiredAuthenticationAcquireClientAuthorizationRequestCard, OptionalAuthenticationAcquireClientAuthorizationRequestCard):
    pass
