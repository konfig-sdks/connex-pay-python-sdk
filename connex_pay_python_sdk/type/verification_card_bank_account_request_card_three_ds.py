...
class RequiredVerificationCardBankAccountRequestCardThreeDs(TypedDict):
    pass

class OptionalVerificationCardBankAccountRequestCardThreeDs(TypedDict, total=False):
    SecureCode: str
...
class VerificationCardBankAccountRequestCardThreeDs(RequiredVerificationCardBankAccountRequestCardThreeDs, OptionalVerificationCardBankAccountRequestCardThreeDs):
    pass
