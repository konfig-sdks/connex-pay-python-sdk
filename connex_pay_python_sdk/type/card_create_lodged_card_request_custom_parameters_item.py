...
class RequiredCardCreateLodgedCardRequestCustomParametersItem(TypedDict):
    pass

class OptionalCardCreateLodgedCardRequestCustomParametersItem(TypedDict, total=False):
...
class CardCreateLodgedCardRequestCustomParametersItem(RequiredCardCreateLodgedCardRequestCustomParametersItem, OptionalCardCreateLodgedCardRequestCustomParametersItem):
    pass
