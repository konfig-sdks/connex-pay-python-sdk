...
class RequiredAuthenticationObtain3DSecureAuthenticationRequestCardThreeDs(TypedDict):
    pass

class OptionalAuthenticationObtain3DSecureAuthenticationRequestCardThreeDs(TypedDict, total=False):
    SecureCode: str
...
class AuthenticationObtain3DSecureAuthenticationRequestCardThreeDs(RequiredAuthenticationObtain3DSecureAuthenticationRequestCardThreeDs, OptionalAuthenticationObtain3DSecureAuthenticationRequestCardThreeDs):
    pass
