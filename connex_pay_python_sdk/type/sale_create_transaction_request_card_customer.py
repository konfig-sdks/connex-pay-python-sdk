...
class RequiredSaleCreateTransactionRequestCardCustomer(TypedDict):
    pass

class OptionalSaleCreateTransactionRequestCardCustomer(TypedDict, total=False):
...
class SaleCreateTransactionRequestCardCustomer(RequiredSaleCreateTransactionRequestCardCustomer, OptionalSaleCreateTransactionRequestCardCustomer):
    pass
