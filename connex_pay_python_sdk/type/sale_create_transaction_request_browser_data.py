...
class RequiredSaleCreateTransactionRequestBrowserData(TypedDict):
...
class OptionalSaleCreateTransactionRequestBrowserData(TypedDict, total=False):
    pass

class SaleCreateTransactionRequestBrowserData(RequiredSaleCreateTransactionRequestBrowserData, OptionalSaleCreateTransactionRequestBrowserData):
    pass
