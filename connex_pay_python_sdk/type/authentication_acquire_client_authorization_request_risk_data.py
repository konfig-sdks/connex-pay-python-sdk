...
from connex_pay_python_sdk.type.authentication_acquire_client_authorization_request_risk_data_flight_data import AuthenticationAcquireClientAuthorizationRequestRiskDataFlightData
from connex_pay_python_sdk.type.authentication_acquire_client_authorization_request_risk_data_flight_passengers import AuthenticationAcquireClientAuthorizationRequestRiskDataFlightPassengers

class RequiredAuthenticationAcquireClientAuthorizationRequestRiskData(TypedDict):
    pass

class OptionalAuthenticationAcquireClientAuthorizationRequestRiskData(TypedDict, total=False):
    ...
    FlightPassengers: AuthenticationAcquireClientAuthorizationRequestRiskDataFlightPassengers

    # Custom Parameters. Array.
    CustomParameters: typing.Dict[str, typing.Union[bool, date, datetime, dict, float, int, list, str, None]]

class AuthenticationAcquireClientAuthorizationRequestRiskData(RequiredAuthenticationAcquireClientAuthorizationRequestRiskData, OptionalAuthenticationAcquireClientAuthorizationRequestRiskData):
    pass
