...
class RequiredAuthenticationObtain3DSecureAuthenticationRequestBrowserData(TypedDict):
...
class OptionalAuthenticationObtain3DSecureAuthenticationRequestBrowserData(TypedDict, total=False):
    pass

class AuthenticationObtain3DSecureAuthenticationRequestBrowserData(RequiredAuthenticationObtain3DSecureAuthenticationRequestBrowserData, OptionalAuthenticationObtain3DSecureAuthenticationRequestBrowserData):
    pass
