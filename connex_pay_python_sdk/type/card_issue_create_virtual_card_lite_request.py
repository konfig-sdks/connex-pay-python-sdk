...
class RequiredCardIssueCreateVirtualCardLiteRequest(TypedDict):
...
class OptionalCardIssueCreateVirtualCardLiteRequest(TypedDict, total=False):
    ...
    MIDWhitelist: CardIssueCreateVirtualCardLiteRequestMidWhitelist

    MIDBlacklist: CardIssueCreateVirtualCardLiteRequestMidBlacklist
    ...
    CustomParameters: CardIssueCreateVirtualCardLiteRequestCustomParameters
    ...
    LabelIDs: CardIssueCreateVirtualCardLiteRequestLabelIDs

class CardIssueCreateVirtualCardLiteRequest(RequiredCardIssueCreateVirtualCardLiteRequest, OptionalCardIssueCreateVirtualCardLiteRequest):
    pass
