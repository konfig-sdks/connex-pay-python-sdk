...
class RequiredSaleCreateTransactionRequestCardThreeDs(TypedDict):
    pass

class OptionalSaleCreateTransactionRequestCardThreeDs(TypedDict, total=False):
    SecureCode: str
...
class SaleCreateTransactionRequestCardThreeDs(RequiredSaleCreateTransactionRequestCardThreeDs, OptionalSaleCreateTransactionRequestCardThreeDs):
    pass
