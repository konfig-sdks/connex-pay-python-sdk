...
from connex_pay_python_sdk.type.card_issue_create_virtual_card_lite_request_transmission_transmission_methods import CardIssueCreateVirtualCardLiteRequestTransmissionTransmissionMethods

class RequiredCardIssueCreateVirtualCardLiteRequestTransmission(TypedDict):
    pass

class OptionalCardIssueCreateVirtualCardLiteRequestTransmission(TypedDict, total=False):
    TransmissionMethods: CardIssueCreateVirtualCardLiteRequestTransmissionTransmissionMethods
...
class CardIssueCreateVirtualCardLiteRequestTransmission(RequiredCardIssueCreateVirtualCardLiteRequestTransmission, OptionalCardIssueCreateVirtualCardLiteRequestTransmission):
    pass
