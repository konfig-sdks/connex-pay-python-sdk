...
from connex_pay_python_sdk.type.card_issuance_create_virtual_card_request_transmission_transmission_methods import CardIssuanceCreateVirtualCardRequestTransmissionTransmissionMethods

class RequiredCardIssuanceCreateVirtualCardRequestTransmission(TypedDict):
    pass

class OptionalCardIssuanceCreateVirtualCardRequestTransmission(TypedDict, total=False):
    TransmissionMethods: CardIssuanceCreateVirtualCardRequestTransmissionTransmissionMethods
...
class CardIssuanceCreateVirtualCardRequestTransmission(RequiredCardIssuanceCreateVirtualCardRequestTransmission, OptionalCardIssuanceCreateVirtualCardRequestTransmission):
    pass
