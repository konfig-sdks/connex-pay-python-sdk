...
class RequiredAuthenticationAcquireClientAuthorizationRequestCardCustomer(TypedDict):
    pass

class OptionalAuthenticationAcquireClientAuthorizationRequestCardCustomer(TypedDict, total=False):
...
class AuthenticationAcquireClientAuthorizationRequestCardCustomer(RequiredAuthenticationAcquireClientAuthorizationRequestCardCustomer, OptionalAuthenticationAcquireClientAuthorizationRequestCardCustomer):
    pass
