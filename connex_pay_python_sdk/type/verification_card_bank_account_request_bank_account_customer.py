...
class RequiredVerificationCardBankAccountRequestBankAccountCustomer(TypedDict):
    pass

class OptionalVerificationCardBankAccountRequestBankAccountCustomer(TypedDict, total=False):
...
class VerificationCardBankAccountRequestBankAccountCustomer(RequiredVerificationCardBankAccountRequestBankAccountCustomer, OptionalVerificationCardBankAccountRequestBankAccountCustomer):
    pass
