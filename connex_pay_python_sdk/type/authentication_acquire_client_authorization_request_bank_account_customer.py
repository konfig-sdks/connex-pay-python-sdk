...
class RequiredAuthenticationAcquireClientAuthorizationRequestBankAccountCustomer(TypedDict):
    pass

class OptionalAuthenticationAcquireClientAuthorizationRequestBankAccountCustomer(TypedDict, total=False):
...
class AuthenticationAcquireClientAuthorizationRequestBankAccountCustomer(RequiredAuthenticationAcquireClientAuthorizationRequestBankAccountCustomer, OptionalAuthenticationAcquireClientAuthorizationRequestBankAccountCustomer):
    pass
