...
class DeletePayeeRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_payee(
        self,
        merchant_guid: str,
        payee_guid: str,
        **kwargs,
        ...
        args = self._delete_payee_mapped_args(
            merchant_guid=merchant_guid,
            payee_guid=payee_guid,
        )
        return await self._adelete_payee_oapg(
    ...
    def delete_payee(
        ...
        return self._delete_payee_oapg(
            path_params=args.path,
        )

class DeletePayee(BaseApi):
    ...
    async def adelete_payee(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_payee(
            merchant_guid=merchant_guid,
            payee_guid=payee_guid,
            **kwargs,
        )
    ...
    def delete_payee(
        ...
        raw_response = self.raw.delete_payee(
            merchant_guid=merchant_guid,
            payee_guid=payee_guid,
        )
