    ...
    async def _amanage_payee_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v1/PushToCard/Payees/{payeeGuid}/{status}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class ManagePayeeRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def amanage_payee(
        self,
        payee_guid: str,
        status: str,
        **kwargs,
        ...
        args = self._manage_payee_mapped_args(
            payee_guid=payee_guid,
            status=status,
        )
        return await self._amanage_payee_oapg(
    ...
    def manage_payee(
        ...
        return self._manage_payee_oapg(
            path_params=args.path,
        )

class ManagePayee(BaseApi):
    ...
    async def amanage_payee(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.amanage_payee(
            payee_guid=payee_guid,
            status=status,
            **kwargs,
        )
    ...
    def manage_payee(
        ...
        raw_response = self.raw.manage_payee(
            payee_guid=payee_guid,
            status=status,
        )
        if validate:
