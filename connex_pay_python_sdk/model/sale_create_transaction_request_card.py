...
class SaleCreateTransactionRequestCard(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def Customer() -> typing.Type['SaleCreateTransactionRequestCardCustomer']:
                return SaleCreateTransactionRequestCardCustomer
        
            @staticmethod
            def ThreeDS() -> typing.Type['SaleCreateTransactionRequestCardThreeDs']:
                return SaleCreateTransactionRequestCardThreeDs
            __annotations__ = {
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["Customer"]) -> 'SaleCreateTransactionRequestCardCustomer': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["ThreeDS"]) -> 'SaleCreateTransactionRequestCardThreeDs': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["Customer"]) -> typing.Union['SaleCreateTransactionRequestCardCustomer', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["ThreeDS"]) -> typing.Union['SaleCreateTransactionRequestCardThreeDs', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        Customer: typing.Union['SaleCreateTransactionRequestCardCustomer', schemas.Unset] = schemas.unset,
        ThreeDS: typing.Union['SaleCreateTransactionRequestCardThreeDs', schemas.Unset] = schemas.unset,
