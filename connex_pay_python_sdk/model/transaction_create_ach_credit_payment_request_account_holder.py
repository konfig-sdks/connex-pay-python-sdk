...
class TransactionCreateAchCreditPaymentRequestAccountHolder(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def Address() -> typing.Type['TransactionCreateAchCreditPaymentRequestAccountHolderAddress']:
                return TransactionCreateAchCreditPaymentRequestAccountHolderAddress
        
            @staticmethod
            def BankAccount() -> typing.Type['TransactionCreateAchCreditPaymentRequestAccountHolderBankAccount']:
                return TransactionCreateAchCreditPaymentRequestAccountHolderBankAccount
            __annotations__ = {
                "FirstName": FirstName,
                "LastName": LastName,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["Address"]) -> 'TransactionCreateAchCreditPaymentRequestAccountHolderAddress': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["BankAccount"]) -> 'TransactionCreateAchCreditPaymentRequestAccountHolderBankAccount': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["Address"]) -> typing.Union['TransactionCreateAchCreditPaymentRequestAccountHolderAddress', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["BankAccount"]) -> typing.Union['TransactionCreateAchCreditPaymentRequestAccountHolderBankAccount', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        Address: typing.Union['TransactionCreateAchCreditPaymentRequestAccountHolderAddress', schemas.Unset] = schemas.unset,
        BankAccount: typing.Union['TransactionCreateAchCreditPaymentRequestAccountHolderBankAccount', schemas.Unset] = schemas.unset,
