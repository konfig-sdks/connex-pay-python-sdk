...
class SaleCreateTransactionRequestRiskData(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def FlightData() -> typing.Type['SaleCreateTransactionRequestRiskDataFlightData']:
                return SaleCreateTransactionRequestRiskDataFlightData
        
            @staticmethod
            def FlightPassengers() -> typing.Type['SaleCreateTransactionRequestRiskDataFlightPassengers']:
                return SaleCreateTransactionRequestRiskDataFlightPassengers
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["FlightData"]) -> 'SaleCreateTransactionRequestRiskDataFlightData': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["FlightPassengers"]) -> 'SaleCreateTransactionRequestRiskDataFlightPassengers': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["FlightData"]) -> typing.Union['SaleCreateTransactionRequestRiskDataFlightData', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["FlightPassengers"]) -> typing.Union['SaleCreateTransactionRequestRiskDataFlightPassengers', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        FlightData: typing.Union['SaleCreateTransactionRequestRiskDataFlightData', schemas.Unset] = schemas.unset,
        FlightPassengers: typing.Union['SaleCreateTransactionRequestRiskDataFlightPassengers', schemas.Unset] = schemas.unset,
