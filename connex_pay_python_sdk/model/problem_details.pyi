...
class ProblemDetails(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["title"], typing_extensions.Literal["type"], typing_extensions.Literal["status"], typing_extensions.Literal["detail"], typing_extensions.Literal["instance"], str, ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["title"], typing_extensions.Literal["type"], typing_extensions.Literal["status"], typing_extensions.Literal["detail"], typing_extensions.Literal["instance"], str, ]):
