...
class AuthenticationAcquireClientAuthorizationResponseCardCustomer(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["guid", "firstName", "lastName", "dateOfBirth", "address1", "address2", "zip", "city", "state", "country", "phone", "email", "ssN4", "driverLicenseNumber", "driverLicenseState", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["guid", "firstName", "lastName", "dateOfBirth", "address1", "address2", "zip", "city", "state", "country", "phone", "email", "ssN4", "driverLicenseNumber", "driverLicenseState", ], str]):
