...
class SaleCreateTransactionResponseCardCustomer(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["FirstName", "LastName", "Email", "Address1", "Address2", "State", "City", "Country", "Zip", "Phone", "SSN4", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["FirstName", "LastName", "Email", "Address1", "Address2", "State", "City", "Country", "Zip", "Phone", "SSN4", ], str]):
