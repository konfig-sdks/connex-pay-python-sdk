...
class SearchMerchantPayeeDto(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["searchTerm", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["searchTerm", ], str]):
