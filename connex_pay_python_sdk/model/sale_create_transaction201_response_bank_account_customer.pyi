...
class SaleCreateTransaction201ResponseBankAccountCustomer(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["guid", "firstName", "lastName", "dateOfBirth", "address1", "address2", "zip", "city", "country", "phone", "email", "ssN4", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["guid", "firstName", "lastName", "dateOfBirth", "address1", "address2", "zip", "city", "country", "phone", "email", "ssN4", ], str]):
