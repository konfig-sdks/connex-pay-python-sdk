...
class AchCreateCreditPaymentRequestAccountHolder(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def Address() -> typing.Type['AchCreateCreditPaymentRequestAccountHolderAddress']:
                return AchCreateCreditPaymentRequestAccountHolderAddress
        
            @staticmethod
            def BankAccount() -> typing.Type['AchCreateCreditPaymentRequestAccountHolderBankAccount']:
                return AchCreateCreditPaymentRequestAccountHolderBankAccount
            __annotations__ = {
                "FirstName": FirstName,
                "LastName": LastName,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["Address"]) -> 'AchCreateCreditPaymentRequestAccountHolderAddress': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["BankAccount"]) -> 'AchCreateCreditPaymentRequestAccountHolderBankAccount': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["Address"]) -> typing.Union['AchCreateCreditPaymentRequestAccountHolderAddress', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["BankAccount"]) -> typing.Union['AchCreateCreditPaymentRequestAccountHolderBankAccount', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        Address: typing.Union['AchCreateCreditPaymentRequestAccountHolderAddress', schemas.Unset] = schemas.unset,
        BankAccount: typing.Union['AchCreateCreditPaymentRequestAccountHolderBankAccount', schemas.Unset] = schemas.unset,
