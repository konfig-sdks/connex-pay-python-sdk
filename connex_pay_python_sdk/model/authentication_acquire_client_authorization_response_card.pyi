...
class AuthenticationAcquireClientAuthorizationResponseCard(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def customer() -> typing.Type['AuthenticationAcquireClientAuthorizationResponseCardCustomer']:
                return AuthenticationAcquireClientAuthorizationResponseCardCustomer
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["customer"]) -> 'AuthenticationAcquireClientAuthorizationResponseCardCustomer': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["first6", "first4", "last4", "cardHolderName", "cardType", "expirationDate", "customer", "guid", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["customer"]) -> typing.Union['AuthenticationAcquireClientAuthorizationResponseCardCustomer', schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["first6", "first4", "last4", "cardHolderName", "cardType", "expirationDate", "customer", "guid", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        customer: typing.Union['AuthenticationAcquireClientAuthorizationResponseCardCustomer', schemas.Unset] = schemas.unset,
