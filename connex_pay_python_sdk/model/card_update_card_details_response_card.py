...
class CardUpdateCardDetailsResponseCard(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def midWhitelist() -> typing.Type['CardUpdateCardDetailsResponseCardMidWhitelist']:
                return CardUpdateCardDetailsResponseCardMidWhitelist
        
            @staticmethod
            def midBlacklist() -> typing.Type['CardUpdateCardDetailsResponseCardMidBlacklist']:
                return CardUpdateCardDetailsResponseCardMidBlacklist
            associationId = schemas.StrSchema
            clientProgram = schemas.StrSchema
            __annotations__ = {
                "cardGuid": cardGuid,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["midWhitelist"]) -> 'CardUpdateCardDetailsResponseCardMidWhitelist': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["midBlacklist"]) -> 'CardUpdateCardDetailsResponseCardMidBlacklist': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["associationId"]) -> MetaOapg.properties.associationId: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["clientProgram"]) -> MetaOapg.properties.clientProgram: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["cardGuid", "amountLimit", "usageLimit", "limitWindow", "expirationDate", "expiration", "firstSix", "lastFour", "nameLine1", "nameLine2", "status", "cardType", "midWhitelist", "midBlacklist", "associationId", "clientProgram", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["midWhitelist"]) -> typing.Union['CardUpdateCardDetailsResponseCardMidWhitelist', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["midBlacklist"]) -> typing.Union['CardUpdateCardDetailsResponseCardMidBlacklist', schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["clientProgram"]) -> typing.Union[MetaOapg.properties.clientProgram, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["cardGuid", "amountLimit", "usageLimit", "limitWindow", "expirationDate", "expiration", "firstSix", "lastFour", "nameLine1", "nameLine2", "status", "cardType", "midWhitelist", "midBlacklist", "associationId", "clientProgram", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        midWhitelist: typing.Union['CardUpdateCardDetailsResponseCardMidWhitelist', schemas.Unset] = schemas.unset,
        midBlacklist: typing.Union['CardUpdateCardDetailsResponseCardMidBlacklist', schemas.Unset] = schemas.unset,
        associationId: typing.Union[MetaOapg.properties.associationId, str, schemas.Unset] = schemas.unset,
        clientProgram: typing.Union[MetaOapg.properties.clientProgram, str, schemas.Unset] = schemas.unset,
