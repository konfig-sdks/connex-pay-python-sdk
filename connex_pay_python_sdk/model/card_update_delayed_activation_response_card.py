...
class CardUpdateDelayedActivationResponseCard(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["cardGuid", "amountLimit", "usageLimit", "limitWindow", "expirationDate", "expiration", "firstSix", "lastFour", "nameLine1", "nameLine2", "status", "activationDate", "cardType", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["cardGuid", "amountLimit", "usageLimit", "limitWindow", "expirationDate", "expiration", "firstSix", "lastFour", "nameLine1", "nameLine2", "status", "activationDate", "cardType", ], str]):
