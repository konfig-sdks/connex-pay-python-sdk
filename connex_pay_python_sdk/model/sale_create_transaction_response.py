...
class SaleCreateTransactionResponse(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def riskResponse() -> typing.Type['SaleCreateTransactionResponseRiskResponse']:
                return SaleCreateTransactionResponseRiskResponse
            ...
            @staticmethod
            def connexPayTransaction() -> typing.Type['SaleCreateTransactionResponseConnexPayTransaction']:
                return SaleCreateTransactionResponseConnexPayTransaction
            ...
            @staticmethod
            def Card() -> typing.Type['SaleCreateTransactionResponseCard']:
                return SaleCreateTransactionResponseCard
            addressVerificationResult = schemas.StrSchema
            cvvVerificationCode = schemas.StrSchema
            cvvVerificationResult = schemas.StrSchema
            cavvResponseCode = schemas.StrSchema
            walletProvider = schemas.IntSchema
            isFromIssueLite = schemas.BoolSchema
        
            @staticmethod
            def labelIds() -> typing.Type['SaleCreateTransactionResponseLabelIds']:
                return SaleCreateTransactionResponseLabelIds
            remainingAmount = schemas.IntSchema
            __annotations__ = {
                "guid": guid,
                "status": status,
                "type": type,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["riskResponse"]) -> 'SaleCreateTransactionResponseRiskResponse': ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["connexPayTransaction"]) -> 'SaleCreateTransactionResponseConnexPayTransaction': ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["Card"]) -> 'SaleCreateTransactionResponseCard': ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["cavvResponseCode"]) -> MetaOapg.properties.cavvResponseCode: ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["labelIds"]) -> 'SaleCreateTransactionResponseLabelIds': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["guid", "status", "type", "batchStatus", "timeStamp", "deviceGuid", "amount", "activated", "tenderType", "effectiveAmount", "riskResponse", "orderNumber", "cardDataSource", "customerID", "batchGuid", "connexPayTransaction", "associationId", "processorStatusCode", "processorResponseMessage", "wasProcessed", "authCode", "refNumber", "customerReceipt", "statementDescription", "generatedBy", "Card", "addressVerificationResult", "cvvVerificationCode", "cvvVerificationResult", "cavvResponseCode", "walletProvider", "isFromIssueLite", "labelIds", "remainingAmount", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["riskResponse"]) -> typing.Union['SaleCreateTransactionResponseRiskResponse', schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["connexPayTransaction"]) -> typing.Union['SaleCreateTransactionResponseConnexPayTransaction', schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["Card"]) -> typing.Union['SaleCreateTransactionResponseCard', schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["cavvResponseCode"]) -> typing.Union[MetaOapg.properties.cavvResponseCode, schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["labelIds"]) -> typing.Union['SaleCreateTransactionResponseLabelIds', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        riskResponse: typing.Union['SaleCreateTransactionResponseRiskResponse', schemas.Unset] = schemas.unset,
        ...
        connexPayTransaction: typing.Union['SaleCreateTransactionResponseConnexPayTransaction', schemas.Unset] = schemas.unset,
        ...
        Card: typing.Union['SaleCreateTransactionResponseCard', schemas.Unset] = schemas.unset,
        ...
        cavvResponseCode: typing.Union[MetaOapg.properties.cavvResponseCode, str, schemas.Unset] = schemas.unset,
        ...
        labelIds: typing.Union['SaleCreateTransactionResponseLabelIds', schemas.Unset] = schemas.unset,
        remainingAmount: typing.Union[MetaOapg.properties.remainingAmount, decimal.Decimal, int, schemas.Unset] = schemas.unset,
