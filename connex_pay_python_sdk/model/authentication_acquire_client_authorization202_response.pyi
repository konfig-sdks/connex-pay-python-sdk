...
class AuthenticationAcquireClientAuthorization202Response(
    ...
    class MetaOapg:
        ...
        class one_of_0(
            ...
            def __getitem__(self, name: typing.Union[typing_extensions.Literal["guid", "status", "timeStamp", "deviceGuid", "amount", "redirectUrl", "redirectUrlRequestPayload", "card", ], str]):
                # dict_instance[name] accessor
                return super().__getitem__(name)
            ...
            def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["guid", "status", "timeStamp", "deviceGuid", "amount", "redirectUrl", "redirectUrlRequestPayload", "card", ], str]):
                return super().get_item_oapg(name)
        ...
        class one_of_1(
            ...
            def __getitem__(self, name: typing.Union[typing_extensions.Literal["guid", "status", "timeStamp", "deviceGuid", "amount", "redirectUrl", "card", ], str]):
                # dict_instance[name] accessor
                return super().__getitem__(name)
            ...
            def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["guid", "status", "timeStamp", "deviceGuid", "amount", "redirectUrl", "card", ], str]):
                return super().get_item_oapg(name)
