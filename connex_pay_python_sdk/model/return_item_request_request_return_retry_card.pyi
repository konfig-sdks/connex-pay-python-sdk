...
class ReturnItemRequestRequestReturnRetryCard(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["CardNumber", "CardHolderName", "Cvv2", "ExpirationDate", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["CardNumber", "CardHolderName", "Cvv2", "ExpirationDate", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        Cvv2: typing.Union[MetaOapg.properties.Cvv2, decimal.Decimal, int, schemas.Unset] = schemas.unset,
