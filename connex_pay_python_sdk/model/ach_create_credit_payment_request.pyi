...
class AchCreateCreditPaymentRequest(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def AccountHolder() -> typing.Type['AchCreateCreditPaymentRequestAccountHolder']:
                return AchCreateCreditPaymentRequestAccountHolder
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["AccountHolder"]) -> 'AchCreateCreditPaymentRequestAccountHolder': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["MerchantGuid", "Amount", "PayeeName", "AccountHolder", "StatementCompanyName", "Description", "OrderNumber", "SequenceNumber", "AssociationId", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["AccountHolder"]) -> 'AchCreateCreditPaymentRequestAccountHolder': ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["MerchantGuid", "Amount", "PayeeName", "AccountHolder", "StatementCompanyName", "Description", "OrderNumber", "SequenceNumber", "AssociationId", ], str]):
