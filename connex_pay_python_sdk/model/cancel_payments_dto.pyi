...
class CancelPaymentsDto(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def payments() -> typing.Type['CancelPaymentsDtoPayments']:
                return CancelPaymentsDtoPayments
            __annotations__ = {
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["payments"]) -> 'CancelPaymentsDtoPayments': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["merchantGuid", "payments", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["payments"]) -> 'CancelPaymentsDtoPayments': ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["merchantGuid", "payments", ], str]):
