...
class CardUpdateLodgedCardResponseCard(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def midWhitelist() -> typing.Type['CardUpdateLodgedCardResponseCardMidWhitelist']:
                return CardUpdateLodgedCardResponseCardMidWhitelist
        
            @staticmethod
            def midBlacklist() -> typing.Type['CardUpdateLodgedCardResponseCardMidBlacklist']:
                return CardUpdateLodgedCardResponseCardMidBlacklist
            __annotations__ = {
                "cardGuid": cardGuid,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["midWhitelist"]) -> 'CardUpdateLodgedCardResponseCardMidWhitelist': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["midBlacklist"]) -> 'CardUpdateLodgedCardResponseCardMidBlacklist': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["cardGuid", "amountLimit", "usageLimit", "limitWindow", "expirationDate", "expiration", "firstSix", "lastFour", "nameLine1", "nameLine2", "status", "cardType", "midWhitelist", "midBlacklist", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["midWhitelist"]) -> typing.Union['CardUpdateLodgedCardResponseCardMidWhitelist', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["midBlacklist"]) -> typing.Union['CardUpdateLodgedCardResponseCardMidBlacklist', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["cardGuid", "amountLimit", "usageLimit", "limitWindow", "expirationDate", "expiration", "firstSix", "lastFour", "nameLine1", "nameLine2", "status", "cardType", "midWhitelist", "midBlacklist", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        midWhitelist: typing.Union['CardUpdateLodgedCardResponseCardMidWhitelist', schemas.Unset] = schemas.unset,
        midBlacklist: typing.Union['CardUpdateLodgedCardResponseCardMidBlacklist', schemas.Unset] = schemas.unset,
